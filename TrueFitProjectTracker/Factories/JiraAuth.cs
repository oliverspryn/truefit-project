...
namespace TrueFitProjectTracker.Factories {
	...
	/// </summary>
        ...
        private static string getPassword() { if (Password == null) { openFile(); } return Password; }

        private static string getURL() { if (URL == null) { openFile(); } return URL; }

        private static string getUserName() { if (UserName == null) { openFile(); } return UserName; }
